...
function checkDate() {
    ...
    if (theDateObjectValue == "") {
        ...
        if (isLeapYear && theDate > 29) {
            spDate.innerHTML = "<img src='Images/error.png'>二月日期不能大於29!";
            spDate.className = "spInCorrect";
        } else if (!isLeapYear && theDate > 28) {
            spDate.innerHTML = "<img src='Images/error.png'>二月日期不能大於28!";
            spDate.className = "spInCorrect";
        } else {
            spDate.innerHTML = "正確";
        ...
        if (theDate > 31) {
            spDate.innerHTML = "<img src='Images/error.png'>一月, 三月, 五月, 七月, 八月, 十月, 十二月日期不能大於31!";
            spDate.className = "spInCorrect";
        }else {
            spDate.innerHTML = "正確";
            spDate.className = "spCorrect";
        ...
        if (theDate > 30) {
            spDate.innerHTML = "<img src='Images/error.png'>四月, 六月, 九月, 十一月日期不能大於30!";
            spDate.className = "spInCorrect";
        }else {
            spDate.innerHTML = "正確";
            spDate.className = "spCorrect";
